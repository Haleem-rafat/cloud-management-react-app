...
import pcImg from "../assats/cyber-bg.png";
    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center md:items-start w-full px-2">
          ...
          <button className="py-3 px-6 sm:w-[60%] my-5 hover:bg-transparent hover:text-indigo-600 border-2 border-indigo-600">
            Get Started
          </button>
        </div>
        <div>
          <img className="w-full " src={pcImg} alt="" />
        </div>
        <div
