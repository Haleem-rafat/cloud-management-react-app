  ...
  return (
    <div className="w-full mt-24 bg-slate-900 text-gray-300 py-8 px-2 ">
      <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 ">
        ...
        <div className=" col-span-2 pt-8 md:pt-2">
          ...
          <form className="flex flex-col sm:flex-row ">
            ...
            />
            <button className="mb-4 p-2 hover:bg-transparent hover:text-indigo-600 border-2 border-indigo-600">
              Subscribe
            </button>
          </form>
        </div>
      ...
      <div className="flex flex-col max-w-[1240px] mx-auto px-2 py-4 justify-between sm:flex-row text-center text-gray-500">
        <p className="py-4">2022 Haleem Rafat, LLC. All rights reserved</p>
