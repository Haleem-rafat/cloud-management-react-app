      ...
      <div className="max-w-[1240px] mx-auto py-12">
        ...
        <div className="grid md:grid-cols-2 ">
          <div className="bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative">
            <span className=" bg-indigo-200 text-indigo-900 rounded-2xl text-xs px-3 py-1">
              STANDER
            </span>
            <div>
            ...
            <div className="text-2xl relative">
              ...
              <button className="w-full py-4 my-4  hover:bg-transparent hover:text-indigo-600 border-2 border-indigo-600">
                Get Started
              </button>
            </div>
          </div>
